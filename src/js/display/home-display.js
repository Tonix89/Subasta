...
export function homeDisplay() {
  ...
  getApi(getUrl).then((data) => {
    ...
    data.forEach((listing) => {
      // console.log(listing);
      const { id, title, description, media, seller, bids } = listing;
                ...
                <div class="col-12 col-md-6 justify-content-between">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <h3 class="m-0 ps-4">${seller.name}</h3>
                    </div>
                  </div>
      ...
      if (bids.length === 0) {
        ...
        bids.forEach((bid, i) => {
          ...
          if (i < 5) {
            if (i === 0) {
              bidHistoryCont.innerHTML += `<div class="d-flex justify-content-between align-items-center">
                          <div class="d-flex">
